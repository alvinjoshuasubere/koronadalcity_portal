    ...
    <div class="app">
        ...
        <main class="egov-full-app" id="Digital GatewayFullApp">
            <section class="egov-app-body">
                <div class="egov-welcome-row"><div><span class="egov-kicker">KORONADAL CITY</span><h1>MAAYUNG<br><b>KORONADELEÑO!</b></h1></div><div class="egov-weather"><i class="fas fa-sun"></i><span>Koronadal<br><small>South Cotabato</small></span></div></div>
                ...
                <section id="egov-services" class="egov-module"><div class="egov-module-title"><div><small>QUICK ACCESS</small><h2>City Services</h2></div><a href="#egov-all-services">See all <i class="fas fa-chevron-right"></i></a></div>
                    <div class="egov-service-grid" id="Digital GatewayServiceGrid">
                ...
                <section class="egov-module"><div class="egov-module-title"><div><small>FEATURED</small><h2>Digital Gateway Services</h2></div><a href="#egov-all-services">View all <i class="fas fa-chevron-right"></i></a></div><div class="egov-feature-row">
