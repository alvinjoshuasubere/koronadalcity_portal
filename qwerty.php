...
body{font-family:"Sora",system-ui,sans-serif;background:#F8FAFC;color:#1E293B;-webkit-font-smoothing:antialiased;font-size:14px;overflow-x:hidden;line-height:1.5}
body::before{content:'';position:fixed;top:-30%;left:-20%;width:80%;height:80%;background:radial-gradient(circle,rgba(29,78,216,0.12),transparent 70%);pointer-events:none;z-index:0}
body::after{content:'';position:fixed;bottom:-30%;right:-20%;width:80%;height:80%;background:radial-gradient(circle,rgba(29,78,216,0.06),transparent 70%);pointer-events:none;z-index:0}
a{color:inherit;text-decoration:none}
button{font-family:inherit;cursor:pointer}
::selection{background:#1D4ED8;color:#fff}

.nav{position:fixed;top:0;left:0;right:0;z-index:100;height:56px;background:rgba(255,255,255,0.9);border-bottom:1px solid #E2E8F0;backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px)}
...
.nav-brand i{font-size:1rem;color:#1D4ED8}
.nav-brand strong{font-size:0.9rem;font-weight:700;color:#0A192F}
.nav-brand small{font-size:0.6rem;font-weight:600;color:#1D4ED8;display:block;line-height:1;margin-top:0}
.nav-r{display:flex;align-items:center;gap:12px}
.nav-back{display:inline-flex;align-items:center;gap:6px;font-size:0.72rem;font-weight:600;padding:6px 14px;border-radius:8px;color:#64748B;border:1px solid #E2E8F0;transition:all 0.15s}
.nav-back:hover{color:#0A192F;background:#F0F5FF}
...
.admin-header h1{font-size:1.6rem;font-weight:800;letter-spacing:-0.02em;color:#0A192F}
.admin-header h1 i{color:#1D4ED8;margin-right:8px}
.admin-header h1 span{display:block;font-size:0.8rem;font-weight:500;color:#64748B;letter-spacing:0}
...
.btn-primary{background:#1D4ED8;color:#fff;box-shadow:0 0 0 rgba(29,78,216,0)}
.btn-primary:hover{background:#0052CC;box-shadow:0 4px 20px rgba(29,78,216,0.4);transform:translateY(-1px)}
.btn-secondary{background:#FFFFFF;color:#1E293B;border:1px solid #E2E8F0}
.btn-secondary:hover{background:#F0F5FF}
.btn-rose{background:rgba(29,78,216,0.15);color:#1D4ED8;border:1px solid rgba(29,78,216,0.2)}
.btn-rose:hover{background:#1D4ED8;color:#fff;box-shadow:0 0 20px rgba(29,78,216,0.3)}
...
.stat-card{background:#FFFFFF;border:1px solid #E2E8F0;border-radius:12px;padding:16px 16px;text-align:center;backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px)}
.stat-card .num{font-size:2rem;font-weight:800;color:#1D4ED8;line-height:1}
.stat-card .lab{font-size:0.6rem;font-weight:600;color:#64748B;text-transform:uppercase;letter-spacing:0.04em;margin-top:4px}

.table-wrap{background:#FFFFFF;border:1px solid #E2E8F0;border-radius:16px;overflow:hidden;backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px)}
table{width:100%;border-collapse:collapse}
thead{background:#F0F5FF}
th{font-size:0.6rem;font-weight:700;text-transform:uppercase;letter-spacing:0.06em;color:#64748B;text-align:left;padding:14px 16px;border-bottom:1px solid #E2E8F0}
td{padding:12px 16px;font-size:0.82rem;border-bottom:1px solid #E2E8F0;color:#94A3B8}
...
.badge{display:inline-block;padding:2px 10px;border-radius:20px;font-size:0.62rem;font-weight:600;text-transform:uppercase;letter-spacing:0.03em;background:rgba(29,78,216,0.15);color:#1D4ED8}
...
.actions-cell button{padding:5px 10px;border-radius:6px;border:none;background:#F8FAFC;color:#64748B;font-size:0.82rem;transition:all 0.2s}
.actions-cell button:hover{background:rgba(29,78,216,0.15);color:#1D4ED8}
...
.mtk-overlay{position:absolute;inset:0;background:rgba(10,25,47,0.5);backdrop-filter:blur(4px);-webkit-backdrop-filter:blur(4px)}
...
.mtk-box{position:relative;z-index:1;background:#FFFFFF;border:1px solid #E2E8F0;border-radius:20px;padding:30px;width:100%;max-width:480px;max-height:90vh;overflow-y:auto;backdrop-filter:blur(40px);-webkit-backdrop-filter:blur(40px);box-shadow:0 30px 80px rgba(10,25,47,0.12)}
.mtk-box h2{font-size:1.3rem;font-weight:700;color:#0A192F;margin-bottom:6px}
.mtk-box p{font-size:0.78rem;color:#64748B;margin-bottom:20px}
.mtk-box form,.mtk-box .modal-body{display:flex;flex-direction:column;gap:14px}
.mtk-box label{font-size:0.68rem;font-weight:600;color:#64748B;text-transform:uppercase;letter-spacing:0.04em}
.mtk-box input,.mtk-box select,.mtk-box textarea{background:#F8FAFC;border:1px solid #E2E8F0;border-radius:8px;padding:10px 14px;font-size:0.9rem;color:#1E293B;font-family:inherit;transition:all 0.2s;width:100%}
.mtk-box input:focus,.mtk-box select:focus,.mtk-box textarea:focus{outline:none;border-color:#1D4ED8;box-shadow:0 0 0 2px rgba(29,78,216,0.2)}
.mtk-box input::placeholder{color:#94A3B8}
.mtk-box textarea{resize:vertical;min-height:80px}
.mtk-box label{display:flex;flex-direction:column;gap:4px}
.mtk-box select{color:#1E293B}
...
table tr{background:#FFFFFF;border:1px solid #E2E8F0;margin-bottom:12px;border-radius:12px;overflow:hidden;padding:8px 0}
table tr:last-child{margin-bottom:0}
td{padding:6px 14px 6px 110px;position:relative;border-bottom:1px solid #E2E8F0}
td::before{position:absolute;left:14px;top:6px;font-weight:600;font-size:0.6rem;text-transform:uppercase;color:#64748B}
.actions-cell{display:flex;gap:6px;padding:10px 14px;background:#F8FAFC;border-bottom:none}
...
.plus-mobile{position:fixed;bottom:20px;right:20px;z-index:99;width:56px;height:56px;border-radius:50%;background:#1D4ED8;color:#fff;border:none;font-size:1.5rem;display:flex;box-shadow:0 6px 30px rgba(29,78,216,0.5);transition:all 0.2s}
...
<div class="nav">
  <div class="nav-in">
    ...
    <div class="nav-r">
      <span style="font-size:0.7rem;color:#1D4ED8;font-weight:600;white-space:nowrap;">Emergency Settings</span>
...
<div class="wrapper">
  ...
  <div class="table-wrap">
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td><strong style="color:#1E293B"><?= htmlspecialchars($c['name'], ENT_QUOTES) ?></strong></td>
          <td>
          ...
          <td class="d-mb" style="font-size:0.78rem;color:#64748B;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:240px;">
        ...
        <tr><td colspan="5" style="padding:40px;text-align:center;color:#64748B;">No emergency contacts yet. Click "Add New" to get started.</td></tr>
        <?php endif ?>
      </tbody>
    </table>
  </div>
  ...
  <div style="margin-top:24px;text-align:center;font-size:0.65rem;color:#94A3B8;padding:12px 0;">
