...
<head>
    ...
    *::after {
    ...
    .orb-1 {
        width: 500px;
        height: 500px;
        background: radial-gradient(circle, rgba(23, 105, 170, 0.35), transparent 70%);
        top: -15%;
        right: -10%;
    ...
    .orb-2 {
        width: 350px;
        height: 350px;
        background: radial-gradient(circle, rgba(23, 105, 170, 0.2), transparent 70%);
        bottom: 10%;
        left: -8%;
    ...
    .brand-img {
        ...
        box-shadow: 0 0 15px rgba(23, 105, 170, 0.25);
    }
    ...
    .nav-back:hover {
        ...
        color: #1769AA;
        box-shadow: 0 0 20px rgba(23, 105, 170, 0.15);
    }
    ...
    .hero::before {
        ...
        position: absolute;
        inset: 0;
        background: radial-gradient(ellipse at 50% 30%, rgba(23, 105, 170, 0.12), transparent 65%);
        pointer-events: none;
    }
    ...
    .pulse-ring {
        ...
        border-radius: 50%;
        border: 2px solid rgba(23, 105, 170, 0.25);
    ...
    .hero h1 {
        ...
        margin-bottom: 12px;
        text-shadow: 0 0 40px rgba(23, 105, 170, 0.2), 0 0 80px rgba(23, 105, 170, 0.08);
    }

    .hero h1 .hl {
        background: linear-gradient(135deg, #163A5F, #1769AA, #3D8FD1);
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;
        background-clip: text;
        filter: drop-shadow(0 0 25px rgba(23, 105, 170, 0.4));
    }
    ...
    .stats-bar {
        ...
        box-shadow: 0 4px 30px rgba(22, 58, 95, 0.10);
        flex-wrap: wrap;
    ...
    .stat-num {
        ...
        color: #1769AA;
        line-height: 1;
        text-shadow: 0 0 15px rgba(23, 105, 170, 0.4);
    }
    ...
    .section-label::after {
        ...
        flex: 1;
        height: 1px;
        background: linear-gradient(90deg, rgba(23, 105, 170, 0.3), transparent);
    }
    ...
    .contact-card::before {
        ...
        background: linear-gradient(135deg, rgba(23, 105, 170, 0.25), transparent 50%) border-box;
    ...
    .contact-card:hover {
        ...
        box-shadow: 0 0 30px rgba(23, 105, 170, 0.3);
    }
    ...
    /* Type colors */
    .type-police .type-icon {
        background: rgba(59, 130, 246, 0.12);
        color: #3b82f6;
    }

    .type-police .type-icon::after {
    ...
    .type-fire .type-icon::after {
        box-shadow: 0 0 20px rgba(249, 115, 22, 0.4);
    }

    .type-hospital .type-icon {
        background: rgba(34, 197, 94, 0.12);
        color: #22c55e;
    }

    .type-hospital .type-icon::after {
        box-shadow: 0 0 20px rgba(34, 197, 94, 0.4);
    }

    .type-medical .type-icon {
        background: rgba(239, 68, 68, 0.12);
        color: #ef4444;
    }

    .type-medical .type-icon::after {
        box-shadow: 0 0 20px rgba(239, 68, 68, 0.4);
    }

    .type-disaster .type-icon {
        background: rgba(245, 158, 11, 0.12);
        color: #f59e0b;
    }

    .type-disaster .type-icon::after {
    ...
    .type-general .type-icon::after {
        box-shadow: 0 0 20px rgba(23, 105, 170, 0.4);
    }
    ...
    .type-police .type-badge {
        background: rgba(59, 130, 246, 0.12);
        color: #3b82f6;
    }

    .type-fire .type-badge {
        background: rgba(249, 115, 22, 0.12);
        color: #f97316;
    }

    .type-hospital .type-badge {
        background: rgba(34, 197, 94, 0.12);
        color: #22c55e;
    }

    .type-medical .type-badge {
        background: rgba(239, 68, 68, 0.12);
        color: #ef4444;
    }

    .type-disaster .type-badge {
        background: rgba(245, 158, 11, 0.12);
        color: #f59e0b;
    }
    ...
    .type-police .card-phone-icon {
        color: #3b82f6;
    }

    .type-fire .card-phone-icon {
        color: #f97316;
    }

    .type-hospital .card-phone-icon {
        color: #22c55e;
    }

    .type-medical .card-phone-icon {
        color: #ef4444;
    }

    .type-disaster .card-phone-icon {
        color: #f59e0b;
    }
    ...
    .type-police .card-phone-num {
        color: #3b82f6;
    }

    .type-fire .card-phone-num {
        color: #f97316;
    }

    .type-hospital .card-phone-num {
        color: #22c55e;
    }

    .type-medical .card-phone-num {
        color: #ef4444;
    }

    .type-disaster .card-phone-num {
        color: #f59e0b;
    }
    ...
    .type-fire .card-phone:hover .card-phone-num {
        text-shadow: 0 0 20px rgba(249, 115, 22, 0.5);
    }

    .type-hospital .card-phone:hover .card-phone-num {
        text-shadow: 0 0 20px rgba(34, 197, 94, 0.5);
    }

    .type-medical .card-phone:hover .card-phone-num {
        text-shadow: 0 0 20px rgba(239, 68, 68, 0.5);
    }

    .type-disaster .card-phone:hover .card-phone-num {
        text-shadow: 0 0 20px rgba(245, 158, 11, 0.5);
    }

    .type-general .card-phone:hover .card-phone-num {
        text-shadow: 0 0 20px rgba(23, 105, 170, 0.5);
    }
    ...
    .footer::before {
        ...
        right: 0;
        height: 1px;
        background: linear-gradient(90deg, transparent, rgba(23, 105, 170, 0.4), transparent);
    }
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            ?>
                ...
                <div class="stat-item">
                    <div class="stat-num"
                        style="color: <?= $cfg['color'] ?>; text-shadow: 0 0 15px <?= $cfg['color'] ?>40;"><?= $count ?>
                    </div>
        ...
        cards.forEach(function(card) {
            card.addEventListener('mouseenter', function() {
                this.style.transform =
                    'perspective(800px) rotateX(2deg) rotateY(-2deg) translateY(-5px)';
            });
